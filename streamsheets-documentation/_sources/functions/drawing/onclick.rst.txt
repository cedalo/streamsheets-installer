...
Assign a function, that will be executed, if the user clicks on a drawing or drawing item. This function can only
...
.. list-table::
   ...
   * - Function
     - Comment
   * - RECT("Drawing", "Rect", 1000, 1000, 3000, 3000, "#000000", "#FFFFFF", ONCLICK(DELETECELLS(A1:C1))
