...
ELLIPSER(DrawingName, Name, CX, CY, Width, Height[, Line, Fill, Angle, RotationCenter, EventFunction])
...
.. list-table::
   ...
   * - Function
     - Result
     - Comment
   * - ELLIPSER("Drawing", "Ellipse", 3000, 3000, 3000, 3000, "#000000", "#FFFFFF", PI()/4, 1)
     - TRUE
     - Draw an ellipse within the previously created drawing named "Drawing". It is rotated by 45 degrees around
       the top center.
