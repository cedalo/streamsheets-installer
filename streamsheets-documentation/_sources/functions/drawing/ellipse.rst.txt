...
Creates an ellipse within the given drawing

**Syntax**

ELLIPSE(DrawingName, Name, X, Y, Width, Height[, LineFormat, FillFormat, EventFunction])
...
.. list-table::
   ...
   * - Function
     - Result
     - Comment
   * - ELLIPSE("Drawing", "Ellipse", 1000, 1000, 3000, 3000, "#000000", "#FFFFFF")
     - TRUE
     - Draw an ellipse within the previously created drawing named "Drawing".
